;;; mono-shell-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme mono-shell "Theme using Template variables with quality of life improvements.")
...
(provide-theme 'mono-shell)
;;; mono-shell-theme.el ends here
