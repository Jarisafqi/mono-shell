...
using ConfigOverrideValue = std::variant<
    bool, std::int64_t, double, std::string, std::vector<std::string>, std::vector<SessionPanelActionConfig>,
    std::vector<IdleBehaviorConfig>, std::vector<NotificationFilterConfig>,
...
struct ThemeConfig {
  ...
  std::string builtinPalette = "Black & White";
