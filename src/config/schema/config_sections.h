...
namespace noctalia::config::schema {
  ...
  // the open per-plugin map (plugin_settings), and config meta keys. Their
  // read/write/validate stay hand-written in the owning file; the names live here
  // so the known-root-key set
