...
namespace settings {
  ...
  using SettingControl = std::variant<
      ...
      OptionalStepperSetting, StepperSetting, ListSetting, KeybindListSetting,
      SessionPanelActionsSetting, IdleBehaviorsSetting, NotificationFiltersSetting, MultiSelectSetting, ButtonSetting,
      ColorSpecPickerSetting, SearchPickerSetting, GestureActionSetting>;
